...
% di regressione dei punti di vehicle_north di minimo t.c. t>= t_cut.
% Il coefficiente angolare di tale retta sarà sarà un indice 'qualitativo' della velocità di spostamento del veicolo.
...
function coeff= vel_displ_with_min(vehicle_north, t_cut,dT,T_final)
